...
export const TransferRequestModal = ({ isOpen, onClose, currentUnit }: TransferRequestModalProps) => {
      ...
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Request transfer for {currentUnit.current_occupant_name} to another unit.
              This will create a transfer request that needs approval.
