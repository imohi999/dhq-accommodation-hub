...
export function MaintenanceTaskForm({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      toast.success(initial ? "Task updated successfully" : `${selectedUnits.length} task(s) created successfully`);
    ...
    <div className="bg-white border rounded-lg p-6 mb-6 space-y-6 shadow-lg">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <Input
              ...
              onChange={e => setForm(f => ({ ...f, lastPerformedDate: e.target.value }))}
            />
          </div>
          <div>
        ...
        <div className="flex gap-2">
          ...
          >
            {initial ? "Update Task" : `Create Task${selectedUnits.length > 1 ? `s (${selectedUnits.length})` : ""}`}
          </LoadingButton>
        ...
        <div className="border-t pt-6">
          ...
          <div className="mt-4 mb-2">
            <div className="flex items-center space-x-2">
              <Checkbox
                id="selectAll"
                checked={selectedUnits.length === filters.filteredUnits.length && filters.filteredUnits.length > 0}
